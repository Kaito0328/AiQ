...
return (
    <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 w-[calc(100%-2rem)] max-w-4xl bg-white/70 backdrop-blur-md shadow-lg p-4 z-10 rounded-2xl transition">
