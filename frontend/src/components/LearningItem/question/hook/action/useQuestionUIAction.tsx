...
import { useUIState } from "../state/useQuestionUIState";

export const useUIAction = (
    uiState: ReturnType<typeof useUIState>
) => {
    const {mergedQuestions, setVisibilityMap, setIsSelecting, setSavedMap, allVisible, setAllVisible } = uiState;
