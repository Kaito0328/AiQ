    ...
    useEffect(() => {
        ...
        const observer = new MutationObserver((mutations) => {
            mutations.forEach((mutation) => {
                if (mutation.type === 'attributes' && mutation.attributeName === 'data-battle-playing') {
                    setIsBattlePlaying(document.body.getAttribute('data-battle-playing') === 'true');
                }
            });
        });
                    ...
                    <div className="flex items-center justify-between h-full">
                        ...
                        <div className="z-10">
                            {isBattleRoom ? (
                                ...
                                >
                                    <LogOut size={20} />
                                    <Text variant="xs" weight="bold" color="danger">退室</Text>
                                </Button>
                            ) : showBackButton ? (
                                <Button
                                    variant="ghost"
                                ...
                                >
                                    <ArrowLeft size={24} />
                                    <Text variant="xs" weight="bold" color="primary" className="hidden sm:inline">戻る</Text>
                                </Button>
                            ) : (
                                <Button
                                    variant="ghost"
