      ...
      {displayRequests.map((req) => (
        ...
        >
          <Flex gap="sm" align="center" className="h-full">
            <View
              className="bg-brand-secondary/10 flex-shrink-0"
              padding="sm"
              rounded="full"
            >
            ...
            <View className="min-w-0 flex-1">
              <Text
                variant="detail"
                weight="bold"
                className="line-clamp-1 transition-colors group-hover:text-brand-primary"
              >
                {req.questionText}
              </Text>
          ...
          <Flex justify="center" align="center" className="min-h-[60px]">
            <Flex gap="xs" align="center">
              <Text variant="detail" weight="bold">
                他 {requests.length - (MAX_DISPLAY - 1)} 件を見る
              </Text>
