...
export function SelectionTray({
    ...
    if (selectedCollections.length === 0) {
        return (
            <View className="fixed bottom-0 left-0 right-0 z-50 p-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                <View className="max-w-2xl mx-auto bg-surface-primary/90 backdrop-blur-md border border-surface-muted shadow-2xl rounded-2xl p-4">
                ...
                <Stack gap="none">
                    <Flex justify="between" align="center" className="px-6 py-3 bg-brand-primary/5 border-b border-brand-primary/10">
                        <Flex gap="sm" align="center">
                            <Flex align="center" justify="center" className="w-8 h-8 rounded-full bg-brand-primary/20 text-brand-primary">
                    ...
                    <View className="px-6 py-4 max-h-32 overflow-y-auto scrollbar-thin scrollbar-thumb-surface-muted bg-surface-primary">
                        <Flex gap="xs" wrap>
